...
router.post('/register', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (id && pass) {
        const check = yield (0, DB_js_1.checkOverlap)('mail', id); // 메일  중복확인
        if (check) { // 중복확인 통과 시
            try {
                const hash = (0, hash_1.default)(id, (new Date()).toString()); // id, Date로 해시 만들기
...
router.get('/hash', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(hash);
    const data = yield (0, DB_js_1.findOne)({ hash }, 'tempmail');
    if (data) {
